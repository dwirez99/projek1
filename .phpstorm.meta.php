...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.F:\DOKUMENT\S4\project1\projek1\public\storage' => 'string',
            'filesystems.public.driver' => 'string',
            'filesystems.public.root' => 'string',
            'filesystems.public.url' => 'string',
            'filesystems.public.visibility' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.F:\\DOKUMENT\\S4\\project1\\projek1\\public\\storage','filesystems.public.driver','filesystems.public.root',
'filesystems.public.url','filesystems.public.visibility','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'livewire.update','livewire.upload-file','livewire.preview-file','home','statusOrtu.index','orangtua.anak',
'orangtua.index','orangtua.create','orangtua.store','orangtua.update','orangtua.destroy',
'pesertadidik.index','pesertadidik.create','pesertadidik.store','pesertadidik.update','pesertadidik.destroy',
'pesertadidik.upload_penilaian','statusgizi.index','statusgizi.create','statusgizi.hitung','statusgizi.store',
'statusgizi.bulkDelete','statusgizi.destroy','statusgizi.exportPdf','artikel.index','artikel.create',
'artikel.store','artikel.edit','artikel.update','artikel.destroy','ckeditor.upload',
'artikel.show','listArtikel','guru.index','login','register',
'password.request','password.reset','verification.notice','verification.verify','password.confirm',
'logout','landingpages','storage.local',);
        registerArgumentsSet('views', 
'artikel.create','artikel.edit','artikel.index','artikel.indexUser','artikel.show',
...
'flux.icon.chevrons-up-down','flux.icon.folder-git-2','flux.icon.layout-grid','flux.navlist.group','guru.index',
'landingpages','layouts.app','livewire.auth.Registration-form','livewire.auth.confirm-password','livewire.auth.forgot-password',
'livewire.auth.login','livewire.auth.register','livewire.auth.reset-password','livewire.auth.verify-email','livewire.daftar-popout',
'livewire.pendaftaran-p-d','livewire.pendaftaran.registration-form-wrapper','livewire.settings.appearance','livewire.settings.delete-user-form','livewire.settings.password',
'livewire.settings.profile','livewire.users.user-index','orangtuas.anakanak','orangtuas.create','orangtuas.index',
'orangtuas.statusgizi','partials.head','partials.settings-heading','penilaian.conclusion','penilaian.conclusion_index',
'penilaian.conclusion_pdf','pesertadidik.create','pesertadidik.index','statusgizi.create','statusgizi.index',
'statusgizi.pdf','templates.footer','templates.navbar','volt-livewire::auth.Registration-form','volt-livewire::auth.confirm-password',
...
'volt-livewire::daftar-popout','volt-livewire::pendaftaran-p-d','volt-livewire::pendaftaran.registration-form-wrapper','volt-livewire::settings.appearance','volt-livewire::settings.delete-user-form',
'volt-livewire::settings.password','volt-livewire::settings.profile','volt-livewire::users.user-index','welcome','e60dd9d2c3a62d619c9acb38f20d5aa5::accent',
...
'PUSHER_APP_CLUSTER','MIX_PUSHER_APP_KEY','MIX_PUSHER_APP_CLUSTER',);
